...
<!-- Karna's Message of Duty -->
<table>
<tr>
<td width="60%">

## 🎯 **The Path of a Code Warrior**

Like **Karna**, the greatest warrior bound by his word, I write code with **unwavering dedication** and **honor**. Every line is a promise, every commit a battle won.

```javascript
const developer = {
  duty: "Write clean, performant code",
  dharma: "Serve the community",
  weapon: "Logic & Algorithms",
  chariot: "Modern Tech Stack",
  armor: "Best Practices",
  goal: "Build solutions that matter"
};
```

**"As Karna never abandoned his duty despite all odds,**  
**I never abandon my code until it's perfect."**
...
## 🌟 **MY DIGITAL CHARIOT (Portfolio)**

<a href="YOUR_PORTFOLIO_LINK" target="_blank">
  <img src="https://img.shields.io/badge/🏛️_VISIT_MY_PORTFOLIO-FFD700?style=for-the-badge&logo=google-chrome&logoColor=black" alt="Portfolio" />
</a>
